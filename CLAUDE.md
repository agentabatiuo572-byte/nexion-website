...
- 验证:`npm run verify`(**14 门**:禁用词/三语 parity/部署门 warn/**launch-assets(R49-F1:统计 mock 镜像·联系渠道·禁用键必配说明,读 dist,prod 阻断)**/**state-hook-consumer(R49-F2:状态钩子零消费即红)**/锚点/brand-parity/particle-hue/**canvas-hazard**/**css-shadowed**/**canvas-geometry**/**render-fit**/**deck-clearance**/**gate-self-tests**);**退出码读 `.verify-exit.code` 文件不读管道**(开跑即置 2,崩溃/中止不会留下上一次的绿)
