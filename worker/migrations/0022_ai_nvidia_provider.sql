-- Add NVIDIA NIM without resetting credentials, generations, leases or usage.
...
CREATE TABLE ai_connection_next (
  ...
  provider TEXT NOT NULL DEFAULT 'zen' CHECK (provider IN ('zen','gemini','openai','anthropic','deepseek','groq','openrouter','nvidia')),
