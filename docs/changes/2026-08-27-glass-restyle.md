...
## R48.10-12 追加(主人连环改令:图与卡的真实感收敛)

- **R48.10 参与路径卡瘦身**:免费卡左文右图(竖窗贴右绝对定位,图不参与撑高;文字列 space-between 吃等高弹性;窄屏近方窗 6/5),扩容卡顶部定高横带+按钮沉底;整台竖立手机(背摄可认)。两次被打回教训:窗口比例必须跟主体形状走 + sharp 预裁,不赌浏览器 cover。
- **R48.11 扩容卡 IDC 机房**:真实机房设备群;v1 网孔柜门在小图犯摩尔纹显糊被否 → v2 玻璃柜门+大块干净面(高精度档)。
- **R48.12 设备四档照**:主人定调**「信任感+真实感」为长期生图铁则**(已入项目记忆)——白底电商棚拍、同族工业设计、零灯条/发光设计;Cloud Share=掌上节点/S1=小盒/Pro=方塔/Rack=2U 机架(共图策略同 App);旧 jpg 移 .trash。
